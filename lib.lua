    ...
    local fonts = {}; do
        ...
        local Medium = Register_Font("Medium", 200, "Normal", {
            Id = "Medium.ttf",
            Font = game:HttpGet("https://github.com/lerxnul/Apex-Hub/raw/refs/heads/main/Inter_28pt-Medium.ttf"),
        })

        local SemiBold = Register_Font("SemiBold", 200, "Normal", {
            Id = "SemiBold.ttf",
            Font = game:HttpGet("https://github.com/lerxnul/Apex-Hub/raw/refs/heads/main/Inter_28pt-SemiBold.ttf"),
        })
        ...
        function library:window(properties)
            local cfg = { 
                ...
                size = properties.size or properties.Size or ((uis.TouchEnabled and not uis.MouseEnabled) and dim2(0, 500, 0, 365) or dim2(0, 700, 0, 565));
                selected_tab;
                items = {};
